...
export default function Modal({ showing, hide, children, title, isFlex=false }: {
    ...
    return (
        <div className={`z-[9999] fixed top-0 left-0 bottom-0 right-0 bg-black/40 ${showing ? 'flex' : 'hidden'}
            ...
            <div className={`rounded-lg bg-main-bg shadow-md w-[600px] max-w-[600px] max-h-[600px] mx-auto
                p-4 min-w-[400px] min-h-[400px] overflow-auto ${isFlex ? 'flex flex-col' : 'block'}`}>
